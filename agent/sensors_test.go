...
func TestNewSensorConfig(t *testing.T) {
	...
	t.Setenv("ANARCHY_PULSE_AGENT_PRIMARY_SENSOR", "test_primary")
	t.Setenv("ANARCHY_PULSE_AGENT_SYS_SENSORS", "/test/path")
	t.Setenv("ANARCHY_PULSE_AGENT_SENSORS", "test_sensor1,test_*,test_sensor3")
	t.Setenv("ANARCHY_PULSE_AGENT_SENSORS_TIMEOUT", "7s")
