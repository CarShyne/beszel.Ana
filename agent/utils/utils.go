...
// GetEnv retrieves an environment variable with a "ANARCHY_PULSE_AGENT_" prefix, or falls back to the unprefixed key.
func GetEnv(key string) (value string, exists bool) {
	if value, exists = os.LookupEnv("ANARCHY_PULSE_AGENT_" + key); exists {
		return value, exists
	}
