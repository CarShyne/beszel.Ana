...
// across multiple systems (POST /api/anarchy-pulse/user-alerts)
...
// (DELETE /api/anarchy-pulse/user-alerts)
...
func (am *AlertManager) SendTestNotification(e *core.RequestEvent) error {
	...
	err = am.SendShoutrrrAlert(data.URL, "Test Alert", "This is a notification from Anarchy Pulse.", am.hub.Settings().Meta.AppURL, "View Anarchy Pulse")
	if err != nil {
